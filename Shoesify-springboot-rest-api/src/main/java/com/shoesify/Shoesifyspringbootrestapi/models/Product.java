...
public class Product {
  ...
  public String toString() {
    return "Product [id=" + id + ", name=" + name + ", brand=" + brand + ", gender=" + gender + ", category=" + category
        + ", price=" + price + ", is_in_inventory=" + is_in_inventory + ", items_left=" + items_left + ", imageURL="
        + imageURL + ", slug=" + slug + "]";
  }
  ...
  public Product(String name, String brand, String gender, String category, int price, boolean is_in_inventory,
      int items_left, String imageURL, String slug) {
    this.name = name;
    this.brand = brand;
    this.gender = gender;
